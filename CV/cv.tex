...
\address{Yorckstr 74 10965, Kreuzberg, Berlin, Germany}

\mobile{(+49) 15759299444}
\email{ashleytwb@gmail.com}
...
\begin{cventries}
  \cventry
    {MEng Electronic Engineering (Partial, did not graduate)} % Degree
    {University of Surrey} % Institution
    {Guildford, England} % Location
    {Oct. 2014 - Aug. 2015} % Date(s)
    {
...
\begin{cventries}
  \cventry
    ...
    {}{\hyperref[https://github.com/IGBC]{''https://github.com/IGBC''}} % Drop left fields
    {
    \begin{cvitems} % Description(s) of tasks/responsibilities
  ...
  \cventry
    ...
    {Active Chaos Comuter Club (CCC) Community Member} % Title
    {}{} % Drop left fields
